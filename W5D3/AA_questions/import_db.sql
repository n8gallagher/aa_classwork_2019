...
VALUES
  ('I am confused','What is a physic?', (SELECT id FROM users WHERE fname = 'steven')), ('How much?', 'Wood would a woodchuck chuck if a woodchuck could chuck wood?', (SELECT id FROM users WHERE fname = 'michael'));
